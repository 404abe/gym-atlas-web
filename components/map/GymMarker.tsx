		...
		<div className="relative flex flex-col items-center">
			...
			>
				<span
					...
					aria-hidden="true"
				/>
				<span className="absolute inset-[6px] grid place-items-center overflow-hidden rounded-full border-2 border-[#050606] bg-gradient-to-br from-[#e7ece9] to-[#75807c] text-[11px] font-bold text-[#151616]">
					{gym.image_url ? (
